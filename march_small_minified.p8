...
k=.01lx=-1.5c=.0002poke2(12866,256)sfx(0)np={12,5,0}::s::
poke2(12800,1606+(t()\8%2)*2+np[t()\.2%3+1])lx-=c
cr=cos(lx/25)sr=-sin(lx/26)cc=lx/4i=rnd(1024)\1+1local x,y,d,s,a,q,p=i\32,i%32,0,0,rs[i],0,{lx+1.5,0,6}::ms::
d=sc(p)if d<.2then
...
goto ms::d::w,v=x*4+rnd(4),y*4+rnd(4)rectfill(w,v,w+4,v+4,q)goto s